...
EquationStatus.addLeftStep = function(equation, leftStep) {
  ...
  return new EquationStatus(equation, leftStep.changeType, substeps);           // todo: changegroups, ie the before and after of the nodestatus
}
...
EquationStatus.addRightStep = function(equation, rightStep) {
  ...
  return new EquationStatus(equation, rightStep.changeType, substeps);          // todo: changegroups, ie the before and after of the nodestatus
}
