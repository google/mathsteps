...
module.exports = {
  ...
  REDUCE_EXPONENT_BY_ZERO: 'Anything to the power of 0 is just 1',
  REMOVE_EXPONENT_BY_ONE: 'Anything to the power of 1 is just itself',
  ...
  MULTIPLY_BY_ZERO: 'Multiplying by 0 results in 0',
  REMOVE_ADDING_ZERO: 'Remove 0 from the sum',
  REMOVE_MULTIPLYING_BY_ONE: 'Remove 1 from the product',
  REMOVE_MULTIPLYING_BY_NEGATIVE_ONE: 'Multiply by -1 to make it negative',
  ...
  MULTIPLY_DENOMINATORS: 'Multiply out the denominators',
  MULTIPLY_NUMERATORS: 'Multiply out the numerators',
  ADD_NUMERATORS: 'Add the numerators together',
  REDUCE_ZERO_NUMERATOR: 'Zero divided by anything is zero',
  DIVIDE_FRACTION_FOR_ADDITION: 'Divide fraction so it\'s also a number',
