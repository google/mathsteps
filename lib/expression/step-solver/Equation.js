...
class Equation {
  ...
  print(latex=false, showPlusMinus=false) {
    let leftSide = printNode(this.leftNode, latex, showPlusMinus);
    let rightSide = printNode(this.rightNode, latex, showPlusMinus);
