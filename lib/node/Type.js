...
NodeType.isOperator = function(node: Object, operator: string | null) {
...
NodeType.isParenthesis = function(node: Object) {
  return node.type === 'ParenthesisNode';
};

NodeType.isUnaryMinus = function(node: Object) {
  return node.type === 'OperatorNode' && node.fn === 'unaryMinus';
};

NodeType.isFunction = function(node: Object, functionName: string | null) {
...
NodeType.isSymbol = function(node: Object, allowUnaryMinus: boolean | true) {
...
NodeType.isConstant = function(node: Object, allowUnaryMinus: boolean=false) {
...
NodeType.isConstantFraction = function(node: Object, allowUnaryMinus:boolean=false) {
...
NodeType.isConstantOrConstantFraction = function(node: Object, allowUnaryMinus:boolean=false) {
...
NodeType.isIntegerFraction = function(node: Object, allowUnaryMinus:boolean=false) {
