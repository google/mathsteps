...
const LikeTermCollector = require('./collectAndCombine/LikeTermCollector');
const resolvesToConstant = require('./util/resolvesToConstant');
...
function canCollectOrCombine(node) {
  return LikeTermCollector.canCollectLikeTerms(node) ||
    ...
    PolynomialTermOperations.canSimplifyPolynomialTerms(node);
}
