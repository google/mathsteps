...
const collectAndCombineLikeTerms = require('./collectAndCombine/collectAndCombine');
const distribute = require('./distribute');
const evaluateArithmetic = require('./evaluateArithmetic');
const evaluateFunctions = require('./evaluateFunctions/evaluateFunctions');
const simplifyBasics = require('./simplifyBasics');
const simplifyDivision = require('./simplifyDivision');
const simplifyFractions = require('./simplifyFractions/simplifyFractions');
