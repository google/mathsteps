...
const collectAndCombineLikeTermsTreeSearch = require('./collectAndCombine');
const distributeTreeSearch = require('./distribute');
const evaluateArithmetic = require('./evaluateArithmetic');
const evaluateFunctions = require('./evaluateFunctions');
const simplifyBasicsTreeSearch = require('./simplifyBasics');
...
function step(node) {
  ...
  const simplificationFunctions = [
    ...
    collectAndCombineLikeTermsTreeSearch,
    // e.g. (2 + x) / 4 => 2/4 + x/4
