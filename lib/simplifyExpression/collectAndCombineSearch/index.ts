...
// Will prioritize deeper expressions. Returns a mathNode.Status object.
...
// multiplication
function collectAndCombineOperation(node: any);
function collectAndCombineOperation(node) {
  ...
  let newNode = mathNode.Status.resetChangeGroups(status.newNode);
