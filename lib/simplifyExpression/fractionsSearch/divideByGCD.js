...
function divideByGCD(fraction) {
  ...
  const intermediateNumerator = Node.Creator.parenthesis(Node.Creator.operator(
    '*', [Node.Creator.constant(numeratorValue/gcd), Node.Creator.constant(gcd)]));
  const intermediateDenominator = Node.Creator.parenthesis(Node.Creator.operator(
    '*', [Node.Creator.constant(denominatorValue/gcd), Node.Creator.constant(gcd)]));
  ...
  status.newNode = Node.Status.resetChangeGroups(status.newNode);
