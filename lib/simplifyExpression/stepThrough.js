...
var Status = require("../mathnode/Status");
var arithmeticSearch = require("./arithmeticSearch");
var basicsSearch = require("./basicsSearch");
var breakUpNumeratorSearch = require("./breakUpNumeratorSearch");
var collectAndCombineSearch = require("./collectAndCombineSearch");
var distributeSearch = require("./distributeSearch");
var divisionSearch = require("./divisionSearch");
var fractionsSearch = require("./fractionsSearch");
var functionsSearch = require("./functionsSearch");
...
function stepThrough(node, debug) {
    ...
    var nodeStatus;
    var steps = [];
    var originalExpressionStr = print(node);
    var maxStepCount = 20;
    var iters = 0;
    ...
    while (nodeStatus.hasChanged()) {
        ...
        var nextNode = Status.resetChangeGroups(nodeStatus.newNode);
...
function step(node) {
    ...
    var simplificationTreeSearches = [
    ...
    for (var i = 0; i < simplificationTreeSearches.length; i++) {
...
function logSteps(nodeStatus) {
    ...
    if (nodeStatus.substeps.length > 0) {
        // eslint-disable-next-line
        console.log("\nsubsteps: ");
        nodeStatus.substeps.forEach(function (substep) { return substep; });
    }
}
