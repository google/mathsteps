...
function flattenSupportedOperation(node: any, parentOp: any);
...
function getOperands(node: any, parentOp: "*");
function getOperands(node: any, parentOp: "+");
function getOperands(node: any, parentOp: any);
...
function flattenDivision(node: any);
