...
function removeUnnecessaryParensSearch(node: any);
...
// Returns a node.
function removeUnnecessaryParensInOperatorNode(node: any);
...
// Returns a node.
function removeUnnecessaryParensInFunctionNode(node: any);
...
// Returns a node.
function removeUnnecessaryParensInParenthesisNode(node: any);
...
function canCollectOrCombine(node: any);
...
export = removeUnnecessaryParens;
