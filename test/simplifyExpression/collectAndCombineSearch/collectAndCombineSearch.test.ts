import collectAndCombineSearch = require('../../../lib/simplifyExpression/collectAndCombineSearch');
import TestUtil = require('../../TestUtil');

function testCollectAndCombineSubsteps(exprString: any, outputList: any, outputStr: any);
...
function testSimpleCollectAndCombineSearch(exprString: any, outputStr: any);
...
describe('combinePolynomialTerms addition', () => {
    const tests = [
        ['x+x',
            ['1x + 1x',
                '(1 + 1) * x',
...
describe('collectAndCombineSearch with no substeps', () => {
    const tests = [
        ['2x + 4x + x', '7x'],
        ['x * x^2 * x', 'x^4']
    ];
