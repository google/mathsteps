import evaluateConstantSum = require('../../../lib/simplifyExpression/collectAndCombineSearch/evaluateConstantSum');
import TestUtil = require('../../TestUtil');

function testEvaluateConstantSum(exprString: any, outputList: any);
