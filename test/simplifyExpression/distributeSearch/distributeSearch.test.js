...
describe('distribute with fractions', function () {
  ...
  const multiStepTests = [
    ...
    ['(2 / x +  3x^2) * (x^3 + 1)',
      ['(2 * (x^3 + 1)) / x + 3 x^2 * (x^3 + 1)', // TODO(printing) spaces with coefficients
        '(2 * (x^3 + 1)) / x + (3 x^5 + 3 x^2)'] // TODO(printing) spaces with coefficients
    ],

    ['(2x + x^2) * (1 / (x^2 -4) + 4x^2)',
      ['(1 * (2x + x^2)) / (x^2 - 4) + 4 x^2 * (2x + x^2)', // TODO(printing) spaces with coefficients
        '(1 * (2x + x^2)) / (x^2 - 4) + (8 x^3 + 4 x^4)'] // TODO(printing) spaces with coefficients
    ],

    ['(2x + x^2) * ((3x^2) / (x^2 -4) + 4x^2)',
      ['(3 x^2 * (2x + x^2)) / (x^2 - 4) + 4 x^2 * (2x + x^2)', // TODO(printing) spaces with coefficients
