...
describe("distribute", function () {
  const tests = [
    ["x*(x+2+y)", ["(x * x + x * 2 + x * y)", "(x^2 + 2x + x * y)"]],
    ["(x+2+y)*x*7", ["(x * x + 2x + y * x) * 7", "(x^2 + 2x + y * x) * 7"]],
    [
      "(5+x)*(x+3)",
      ["(5 * (x + 3) + x * (x + 3))", "((5x + 15) + (x^2 + 3x))"],
    ],
    ["-2x^2 * (3x - 4)", ["(-2x^2 * 3x - 2x^2 * -4)", "(-6x^3 + 8x^2)"]],
  ];
...
describe("expand base", function () {
  const tests = [
    ...
    [
      "3 * (nthRoot(x, 2))^4",
      "3 * nthRoot(x, 2) * nthRoot(x, 2) * nthRoot(x, 2) * nthRoot(x, 2)",
    ],
    [
      "(nthRoot(x, 2) + nthRoot(x, 3))^2",
      "(nthRoot(x, 2) + nthRoot(x, 3)) * (nthRoot(x, 2) + nthRoot(x, 3))",
    ],
    ["(2x + 3)^2", "(2x + 3) * (2x + 3)"],
    ["(x + 3 + 4)^2", "(x + 3 + 4) * (x + 3 + 4)"],
