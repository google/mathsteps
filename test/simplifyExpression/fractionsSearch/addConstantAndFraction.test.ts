import addConstantAndFraction = require("../../../lib/simplifyExpression/fractionsSearch/addConstantAndFraction");
import TestUtil = require("../../TestUtil");

function testAddConstantAndFraction(exprString: any, outputList: any);
...
describe("addConstantAndFraction", () => {
    const tests = [
        ["7 + 1/2",
            ["14/2 + 1/2",
                "(14 + 1) / 2",
