import addConstantFractions = require("../../../lib/simplifyExpression/fractionsSearch/addConstantFractions");
import TestUtil = require("../../TestUtil");

function testAddConstantFractions(exprString: any, outputList: any);
