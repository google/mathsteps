import cancelLikeTerms = require('../../../lib/simplifyExpression/fractionsSearch/cancelLikeTerms');
import TestUtil = require('../../TestUtil');

function testCancelLikeTerms(exprStr: any, expectedStr: any);
function testCancelLikeTerms(exprStr, expectedStr) {
  TestUtil.testSimplification(cancelLikeTerms, exprStr, expectedStr);
}

describe('cancel like terms', () => {
    const tests = [
        ['2/2', '1'],
        ['x^2/x^2', '1'],
