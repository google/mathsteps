import nthRoot = require('../../../lib/simplifyExpression/functionsSearch/nthRoot');
import TestUtil = require('../../TestUtil');

function testNthRoot(exprString: any, outputStr: any);
function testNthRoot(exprString, outputStr) {
  TestUtil.testSimplification(nthRoot, exprString, outputStr);
}

describe('simplify nthRoot', () => {
    const tests = [
        ['nthRoot(4)', '2'],
        ['nthRoot(8, 3)', '2'],
...
function testNthRootSteps(exprString: any, outputList: any);
