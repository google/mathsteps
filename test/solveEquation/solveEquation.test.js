...
describe('solveEquation for =', function () {
  const tests = [
    ...
    */
    ...
    // TODO: Partial result: ['(3x + 2)^2 = 2', 'x = nthRoot(2, 2) / 3 - 2/3'],
    // TODO: Partial result: ['(3x + 2)^2 + 2 = 1']
    // -------------------------------------------------------------------------
    ...
    // TODO: Partial result: ['x^6 - x = 0', NO_STEPS],

    // TODO: Partial result: ['4x^2 - 25y^2', ''],
